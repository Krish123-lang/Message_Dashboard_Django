...
SECRET_KEY = "django-insecure-$n-wxvyby-uq(*%oacdhefn(4^uxjcs&08ogl4jf4dz*@g9el$"
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the Message Dashboard",

    # Copyright on the footer
    "copyright": "Message_Dashboard",
